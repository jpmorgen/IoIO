...
#make_movie(t, '/data/IoIO/analysis/test_Na.mp4', start=start, stop=stop)
#make_movie(t, '/data/IoIO/analysis/test_Na_apertures.mp4', reduction_suffix='_apertures',
#           start=start, stop=stop)
t = QTable.read('/data/IoIO/Torus/Torus_cleaned.ecsv')
make_movie(t, '/data/IoIO/analysis/test_SII.mp4', start=start, stop=stop)

#make_movie(t, '/data/IoIO/analysis/test_SII_reduction.mp4', reduction_suffix='_reduction',
#           start=start, stop=stop)
